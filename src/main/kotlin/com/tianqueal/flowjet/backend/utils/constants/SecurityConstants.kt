...
object SecurityConstants {
    ...
    const val DEFAULT_PROJECT_MEMBER_INVITATION_TOKEN_EXPIRATION_SECONDS: Long = 60 * 60L // 1 hour
    ...
    const val TOKEN_PURPOSE_PROJECT_MEMBER_INVITATION = "project_member_invitation"
