...
class ProjectServiceImpl(
    ...
    override fun findAll(
        ...
        val securitySpec = when (accessType) {
        ...
        return projectRepository.findAll(
            securitySpec.and(filterSpec), pageable
        ).map(projectMapper::toDto)
    }

    @Transactional(readOnly = true)
    override fun findById(id: Long): ProjectResponse {
        val projectEntity = projectRepository.findByIdOrNull(id)
    ...
    ): ProjectResponse = projectRepository.save(
    ...
    override fun create(
        userId: Long,
        createProjectRequest: CreateProjectRequest,
    ): ProjectResponse = userRepository.findByIdOrNull(userId)
