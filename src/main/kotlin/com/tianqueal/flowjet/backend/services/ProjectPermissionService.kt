...
class ProjectPermissionService(
  ...
  fun isOwner(id: Long, userId: Long): Boolean {
    val project = projectRepository.findByIdOrNull(id) ?: return false
    return project.projectOwner.id == userId
  }

  fun isMember(id: Long, userId: Long): Boolean = projectMemberRepository.isMember(id, userId)

  fun canRead(id: Long, userId: Long): Boolean {
    return isOwner(id, userId) || isMember(id, userId)
  }

  fun canUpdate(id: Long, userId: Long): Boolean {
    return isOwner(id, userId)
  }

  fun canDelete(id: Long, userId: Long): Boolean {
    return isOwner(id, userId)
  }
}
