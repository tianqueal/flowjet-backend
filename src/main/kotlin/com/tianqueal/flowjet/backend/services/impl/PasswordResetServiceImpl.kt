...
class PasswordResetServiceImpl(
     ...
     */
    override fun generatePasswordResetToken(email: String) = jwtTokenProvider.generatePasswordResetTokenDetails(email).token
     ...
     */
    override fun verifyTokenAndResetPassword(
        token: String,
        newPassword: String,
