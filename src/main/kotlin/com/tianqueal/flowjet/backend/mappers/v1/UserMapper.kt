...
class UserMapper(
    ...
    fun toEntity(dto: CreateAdminUserRequest): UserEntity = toEntityCommon(dto.username, dto.email, dto.name, dto.avatarUrl)

    fun toEntity(dto: CreateUserRequest): UserEntity = toEntityCommon(dto.username, dto.email, dto.name, dto.avatarUrl)

    fun toEntity(dto: UserRegisterRequest): UserEntity = toEntityCommon(dto.username, dto.email, dto.name, null)
