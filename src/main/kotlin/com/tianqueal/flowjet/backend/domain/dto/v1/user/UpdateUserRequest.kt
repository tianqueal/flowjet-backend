...
data class UpdateUserRequest(
    ...
    @field:Schema(
        description = """
            Indicates when the user account itself expires.
            Used for temporary accounts (e.g., trials, contracts).
            If null, the account never expires. If provided, will be updated.
        """,
        example = "2020-01-01T00:00:00Z",
        nullable = true,
        requiredMode = RequiredMode.NOT_REQUIRED,
    ...
    @field:Schema(
        description = """
            Indicates when the user's credentials (e.g., password) expire, forcing a change.
            If null, the credentials never expire. If provided, will be updated.
        """,
        example = "2020-01-01T00:00:00Z",
        nullable = true,
        requiredMode = RequiredMode.NOT_REQUIRED,
